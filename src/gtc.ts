import {
  ...
  GTCDistChanged as GTCDistChangedEvent,
...
export function handleGTCDistChanged(event: GTCDistChangedEvent): void {
  let entity = new GTCDistChanged(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.delegator = event.params.delegator
...
export function handleMinterChanged(event: MinterChangedEvent): void {
  let entity = new MinterChanged(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
